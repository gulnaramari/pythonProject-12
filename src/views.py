...
from src.utils import (fetch_user_data, filter_transactions_by_date, greeting_twenty_four_hours, analyze_dict_user_card,
...
def main(input_date: Any, user_settings: Any) -> Any:
